...
const Section2 = () => {
  ...
  return (
    <section className="px-[1.2rem] md:px-[2.5rem] lg:px-[8rem] py-10 bg-[#30304C]">
      ...
      <div className="mt-5 text-white flex md:gap-20 items-start md:items-end justify-between">
      ...
      >
        {items.map((item, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center border h-[10rem] w-[12rem] rounded-md text-white overflow-hidden transition-all duration-300 hover:bg-[#4FA2AE]"
          >
