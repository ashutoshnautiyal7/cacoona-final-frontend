        ...
        <div className=" flex flex-col items-center w-full md:w-fit">
          ...
          >
            ...
            <input
              ...
              className="text-[#B5B5B5] p-3 border border-[#C4C4C4] rounded-lg outline-none bg-transparent w-full md:w-[18rem] lg:w-[25rem]"
            />
            <div className="flex justify-between mx-1 mt-3 mb-1 text-[12px]">
            ...
            <button className="bg-[#4FA2AE] w-full p-3 rounded-xl mt-2">
              Sign in
            </button>
          ...
          <Link href="/registration" className="mt-2">
            <b className="text-[12px] font-medium text-[#AFAFAF]">Don’t have an account?</b>
            <b className="text-[12px] font-medium text-[#4FA2AE]"> Sign up for free!</b>
          </Link>
        </div>
